...
export type LocaleKey = "en" | "zh" | "zh-TW" | "ja" | "ko" | "ru" | "fr";
...
export function resolveLocaleKey(lang: string | undefined): LocaleKey {
  ...
  if (normalized === "fr" || normalized === "french" || normalized === "francais" || normalized === "français" || normalized === "fr-fr") return "fr";
  return "en";
}

export { en, zh, zhTW as "zh-TW", ja, ko, ru, fr };
